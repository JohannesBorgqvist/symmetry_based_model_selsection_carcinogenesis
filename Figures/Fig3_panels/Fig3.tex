...
{\includegraphics[width=0.75\textwidth]{./PLM_fit/PLM_fit.pdf}};
\node[inner sep=0pt] (power_law) at (6,5.5)
{\includegraphics[width=0.75\textwidth]{./IM-II_fit/IM-II_fit}};
  \node[inner sep=0pt] (exponential) at (0,-6)
    {\includegraphics[width=0.75\textwidth]{./model_sel/model_sel}};
