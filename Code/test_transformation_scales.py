...
# =================================================================================
# =================================================================================
epsilon_vector_IM_III_myeloma = np.linspace(0.0,0.6795*epsilon_scale_IM_III_myeloma,num=10,endpoint=True)
...
# Subplot 1: Myeloma
axes[0].plot(epsilon_vector_IM_III_myeloma,RMS_transf_IM_III_myeloma,'-', color = (2/256,56/256,88/256),label='IM-III Colon cancer')
