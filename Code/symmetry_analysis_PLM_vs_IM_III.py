...
print("\t\t\tPLM\tAll datasets:\t epsilon_scale\t=\t%0.12f"%(3*epsilon_scale_PLM))
print("\t\t\tIM-III\t myeloma:\t epsilon_scale\t=\t%0.12f"%(3*epsilon_scale_IM_III_myeloma))
print("\t\t\tIM-III\t colon:\t epsilon_scale\t=\t%0.12f"%(3*epsilon_scale_IM_III_colon))
print("\t\t\tIM-III\t CML:\t epsilon_scale\t=\t%0.12f\n\n"%(3*epsilon_scale_IM_III_CML))
...
epsilon_vector_PLM = np.linspace(0,3*epsilon_scale_PLM,1000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------------------------
epsilon_vector_IM_III_myeloma = np.linspace(0,3*epsilon_scale_IM_III_myeloma,1000,endpoint=True)
epsilon_vector_IM_III_colon = np.linspace(0,3*epsilon_scale_IM_III_colon,1000,endpoint=True)
epsilon_vector_IM_III_CML = np.linspace(0,3*epsilon_scale_IM_III_CML,1000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
...
#----------------------------------------------------------------------------------
# IM-III MYELOMA
epsilon_transf_IM_III_myeloma = results[1][1] # IM-III transformation parameters
...
epsilon = epsilon_transf_PLM_colon[len(epsilon_transf_PLM_colon)-1]
...
epsilon = epsilon_transf_IM_III_colon[len(epsilon_transf_IM_III_colon)-1]
# Allocate memory for a list
R_IM_III_trans = []
t_IM_III_trans = []
# Allocate an index vector
