...
epsilon_vector_PLM = np.linspace(0,5*epsilon_scale_PLM,5000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------------------------
epsilon_vector_IM_III_myeloma = np.linspace(0,2*epsilon_scale_IM_III_myeloma,5000,endpoint=True)
epsilon_vector_IM_III_colon = np.linspace(0,2*epsilon_scale_IM_III_colon,5000,endpoint=True)
epsilon_vector_IM_III_CML = np.linspace(0,2*epsilon_scale_IM_III_CML,5000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
