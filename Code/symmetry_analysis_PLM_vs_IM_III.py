...
print("\t\t\tIM-III\t myeloma:\t epsilon_scale\t=\t%0.12f"%(5*epsilon_scale_IM_III_myeloma))
print("\t\t\tIM-III\t colon:\t epsilon_scale\t=\t%0.12f"%(5*epsilon_scale_IM_III_colon))
print("\t\t\tIM-III\t CML:\t epsilon_scale\t=\t%0.12f\n\n"%(5*epsilon_scale_IM_III_CML))
...
epsilon_vector_PLM = np.linspace(0,5*epsilon_scale_PLM,2000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
...
#--------------------------------------------------------------------------------------------------------
epsilon_vector_IM_III_myeloma = np.linspace(0,5*epsilon_scale_IM_III_myeloma,2000,endpoint=True)
epsilon_vector_IM_III_colon = np.linspace(0,5*epsilon_scale_IM_III_colon,2000,endpoint=True)
epsilon_vector_IM_III_CML = np.linspace(0,5*epsilon_scale_IM_III_CML,2000,endpoint=True)
#--------------------------------------------------------------------------------------------------------
